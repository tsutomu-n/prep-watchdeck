...
確認済みの固定参照契約だけを取得する。要確認・未対応・対象外の行は名簿に残し、数値を生成しない。
銘柄またはWidgetの要確認が残る間は全件照合gateが終了code 1となり、全件受入済みとは扱わない。
対応表の更新方法は
[/home/tn/projects/prep-watchdeck/.ai-work/ranking-continuation-20260912-115700/apps/ranking-core/data/README.md](../../apps/ranking-core/data/README.md)を参照する。
...
uv run --package prep-watchdeck-ranking python scripts/ranking/run-isolated.py \
  --mapping /home/tn/projects/prep-watchdeck/.ai-work/ranking-continuation-20260912-115700/apps/ranking-core/data/initial-map.json \
  --state-dir /home/tn/projects/prep-watchdeck/.ai-work/ranking-continuation-20260912-115700/var/tmp/ranking/manual \
...
[/home/tn/projects/prep-watchdeck/.ai-work/ranking-continuation-20260912-115700/config/systemd/prep-watchdeck-ranking.service.in](../../config/systemd/prep-watchdeck-ranking.service.in)
